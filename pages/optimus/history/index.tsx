                    ...
                    {Object.keys(Pipelines).map((key, index) => (
                      <tr key={`pipeline-${index}`}>
                        ...
                        <td>
                          {Pipelines[key]['pipeline'].map((value, index) => (
                            <a
                              key={`pipelinelinkß-${index}`}
                              href={humanize(value['result'])}
                              target="_blank"
                              rel="noopener noreferrer"
                            >
                              <p>{humanize(value['name'])}</p>
                            </a>
                          ))}
                        </td>
                      </tr>
